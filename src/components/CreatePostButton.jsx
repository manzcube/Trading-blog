...
const CreatePostButton = ({ onClick }) => {
  return (
    <button onClick={onClick} className="group block max-w-xs mb-10 rounded-lg p-6 shadow-md bg-white ring-1 ring-slate-900/5 createPostBtn space-y-3 hover:bg-sky-500 hover:ring-sky-500 hover:scale-95">
