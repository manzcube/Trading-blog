...
const News = () => {
    ...
    const searchNews = () => {
        if (userContext === "manzcube@gmail.com") {
    ...
    return userContext ? (
        <div className='pb-10'>
            <div className='sm:mx-40'>
                <span className='flex justify-center uppercase w-full font-bold text-xl my-10'>News Sources</span>
                <div className="flex flex-col justify-center py-3 sm:flex-row sm:items-center">
                    <a href="https://www.marketwatch.com/latest-news?mod=top_nav" className='bg-white border max-h-10 shadow-md py-3 px-10 mx-5 my-2 rounded-md text-sky-500 text-sm flex items-center hover:scale-95' target="_blank" rel="noreferrer">
                    ...
                    <a href="https://www.investopedia.com/news-4427706" className='bg-white border max-h-10 shadow-md py-3 px-10 mx-5 my-2 rounded-md text-sky-500 text-sm flex items-center hover:scale-95' target="_blank" rel="noreferrer">
                    ...
                    <a href="https://cointelegraph.com/" className='bg-white border max-h-10 shadow-md py-3 px-10 mx-5 my-2 rounded-md text-sky-500 text-sm flex items-center hover:scale-95' target="_blank" rel="noreferrer">
            ...
            <div className='flex items-center'>
                ...
                <div className="w-full flex flex-wrap justify-center">
                    {data?.map(post => (
                        <div key={data.indexOf(post)} className="bg-white max-w-sm rounded overflow-hidden shadow-lg m-8">
